...
// A successful write must be followed by a new read, even if a poll started earlier.
async function refreshAfterWrite(){await refreshTask;await refresh();}
