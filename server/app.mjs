...
export function createApp({ dbPath = resolve('data/bikes.sqlite'), origins = [], publicDir = resolve('public'), rateLimit = 120, registerLimits = { minute: 15, hour: 90, day: 300, client: 10 } } = {}) {
